...
import static by.kes.specification.location.domain.GeometryType.POLYGON;
import static by.kes.specification.location.domain.Point.NULL_POINT;
...
import by.kes.specification.location.domain.Polygon;
